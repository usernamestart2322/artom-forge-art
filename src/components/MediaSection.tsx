...
const MediaSection = () => {
  const mediaItems = [
    ...
    {
      title: "Инновации в производстве авиационных компонентов",
    ...
    {
      title: "25 лет успешной работы в авиастроении",
      description: "Юбилейный материал о достижениях ООО АРТОМ за четверть века работы в области высокоточного производства.",
      date: "22 июня 2024",
