              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="prose prose-lg text-foreground">
                  <p className="text-muted-foreground leading-relaxed">
                    ООО «АРТОМ» - активно развивающееся предприятие. В 90-х годах, когда научно-исследовательские институты перестали получать государственные заказы, и многим пришлось бороться за выживание Вакаловым Александром Алексеевичем в Омском НИИДе был создан экспериментальный участок для отработки прогрессивных процессов горячей штамповки, порошковой металлургии и литья и в 1991 году организовано Общество с ограниченной ответственностью «АРТОМ».
                  </p>
                  
                  <p className="text-muted-foreground leading-relaxed">
                    Первой продукцией данного предприятия были товары народного потребления, производимые методом порошковой металлургии. В 1992 году ООО «АРТОМ» заключило первый договор по освоению горячей штамповки заготовок лопаток газотурбинных двигателей для ремонта импортных стационарных газоперекачивающих станций, ставшими основной для него в последующие годы продукцией.
                  </p>
